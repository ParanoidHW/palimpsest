...
> 资料状态：已核验完整 arXiv v2 PDF（24 页）与完整 LaTeX source；原论文配图为最终 PDF 的 300 DPI 严格裁剪。官方代码固定在 commit `0c279dd11ca13a70b676cd60ca9673e093526b9a`。官方 ICML poster 60900 页面明确关联 Spotlight presentation。所有工作文件均留在本 delegated process folder，未执行正式知识库 promotion。
...
- 机制图：Figure 1，`figures/crops/fig1-overall-architecture-caption.png`。
- 结果/系统证据图：Figure 8，`figures/crops/fig8-multimodal-dependency-caption.png`。
- 批量 QA：`figures/contact-sheet.png`；详情见 `figure_inventory.md`。
...
![Figure 1 — SplAttN mechanism](figures/crops/fig1-overall-architecture-caption.png)
...
![Figure 8 — KITTI counterfactual evidence](figures/crops/fig8-multimodal-dependency-caption.png)
