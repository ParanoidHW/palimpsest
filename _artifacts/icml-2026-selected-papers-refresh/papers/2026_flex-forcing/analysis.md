...
- 当前文档版本：`1.0.0`
- 当前修订 ID：`rev-source-complete-20260724`
- 当前修订时间：`2026-07-24T20:20:34+08:00`
- 替代版本：`rev-initial` / `0.1.0` / previous deliverable manifest `075d43a87072c1b36cf647ac3a6ca1513c68dd44bdf23e86982108de8e32310d`
...
- 原论文视觉：Figure 3 `figures/crops/fig3-flexible-chunking-mechanism-caption.png`；Table 2 `figures/crops/table2-five-second-performance-caption.png`；完整字段与 QA 见 `figure_inventory.md`。
...
![Figure 3: Flex-Forcing mechanism](figures/crops/fig3-flexible-chunking-mechanism-caption.png)
...
![Table 2: five-second speed and quality results](figures/crops/table2-five-second-performance-caption.png)
