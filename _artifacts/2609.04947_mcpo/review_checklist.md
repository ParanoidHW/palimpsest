...
- [done] Q19 Every key formula has an adjacent explanation card; the symbol table is not used as a substitute for explaining what the formula computes and why.
