...
| LVSA | Table 1 | 80GB 长视频 wall-time / OOM | `papers/2605_lvsa/figures/crops/table1_wall_time_caption.png` | 性能证据 |
| LVSA | Fig.4 | wall-time 随 horizon 缩放 | `papers/2605_lvsa/figures/crops/fig4_wall_time_scaling_caption.png` | 性能证据 |
...
- 逐张在原分辨率下检查图体、legend/axis、完整 caption、外边距和相邻正文；contact sheet 仅用于批量初筛。
