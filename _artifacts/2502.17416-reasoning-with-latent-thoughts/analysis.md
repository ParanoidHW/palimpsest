...
> - 上位汇总：[Linear Attention Transformer 演化](../../02_model_systems/llm_foundations/surveys/linear-attention-transformer-evolution.md)
> - 正式资产：`figures/`
> - 证据索引：[Figure inventory](../../02_model_systems/llm_foundations/evidence/figure-inventory.md)
...
- 原始图表：Figure 1、2、3、4、5 与 Table 1、2、3、4；逐项页码、bbox、完整 caption 和 QA 见 [Figure inventory](../../02_model_systems/llm_foundations/evidence/figure-inventory.md)。
...
![Figure 1：循环架构、等参数/等 FLOPs 基线与 middle looping](figures/fig1-looping-architecture-caption.png)
...
![Table 1：addition 与 p-hop](figures/table1-addition-phop-caption.png)
...
![Table 2：符号 i-GSM 的循环次数与准确率](figures/table2-igsm-results-caption.png)
...
![Table 3：语言模型主结果](figures/table3-language-model-results-caption.png)
...
![Figure 2：相同验证困惑度附近的下游轨迹](figures/fig2-inductive-bias-isoplots-caption.png)
