...
> [!info] 文档关系
> - 文档类型：Paper
> - 正式 owner：`02_model_systems/multimodal_generation/papers/magi-1.md`
> - 中间证据：`_artifacts/magi-1/`
> - 裁剪追溯：[Figure inventory](figure_inventory.md)
...
- 当前文档版本：`1.0.0`
- 当前修订 ID：`rev-initial-20260721`
- 当前修订时间：`2026-07-21T21:00:00+08:00`
- 替代版本：无，首次交付

| 修订 ID | 版本 | 时间 | 修订者 | 类型 | 替代修订 | 摘要 | 对结论影响 |
|---|---|---|---|---|---|---|---|
| `rev-initial-20260721` | `1.0.0` | 2026-07-21T21:00:00+08:00 | Codex | initial | 无 | 首次可审计交付：论文、原图、官方代码、chunk/token 核算、系统证据与局限 | material |
...
| AI 生成图 | 未生成：当前图像工具只有 `generate/edit`，不支持该 review workflow 要求的 `responses-doc --input-file analysis.md` 文档输入链路 |
...
![MAGI-1 Figure 1：chunkwise-AR 与 block-causal mask](figures/crops/fig1-chunkwise-ar-caption.png)
...
![MAGI-1 Figure 3：Auto-Regressive Denoising Model](figures/crops/fig3-ardf-architecture-caption.png)
...
![MAGI-1 Table 6：推理优化与 latency](figures/crops/table6-inference-latency-caption.png)
...
## 5. MagiAttention 与 Infrastructure

![MAGI-1 Figure 14：MagiAttention](figures/crops/fig14-magi-attention-caption.png)
