...
> 调研日期：2026-07-02  
> 中间产物：`output/speculative-decoding-deep-research/`  
...
- **论文元数据与全文线索**：通过 arXiv API 检索并整理了 39 篇 paper 到 `output/speculative-decoding-deep-research/paper_db.jsonl`；Semantic Scholar 公共 API 当时返回 429，因此没有编造 citation count。
...
![投机推理方法时间演进趋势](../../output/speculative-decoding-deep-research/speculative_reasoning_timeline.png)
...
- 论文库：`output/speculative-decoding-deep-research/paper_db.jsonl`
- Frontier：`output/speculative-decoding-deep-research/phase1_frontier/frontier.md`
- Survey：`output/speculative-decoding-deep-research/phase2_survey/survey.md`
- Deep Dive：`output/speculative-decoding-deep-research/phase3_deep_dive/deep_dive.md`
- Code ecosystem：`output/speculative-decoding-deep-research/phase4_code/code_repos.md`
- Synthesis / gaps：`output/speculative-decoding-deep-research/phase5_synthesis/`
