...
| [并行切分方法体系](../surveys/parallel-partitioning-taxonomy.md) | [PP](../assets/surveys/parallel-partitioning-taxonomy/pipeline-parallel-schedule.png) | stage ownership、loss 从末级启动并逐边界返回的 activation-gradient P2P、stage-local weight/gradient/optimizer-state update、fill-drain 时间线与 bubble | `2400×1350` | 教学整理图 / 非论文证据 | passed：LuaLaTeX、原分辨率逐图检查、loss → stage 3 → 2 → 1 → 0 backward 拓扑、本地模型状态更新、P2P/ownership/bubble/节点类型语义 QA，2026-08-04 |
...
| [并行切分方法体系](../surveys/parallel-partitioning-taxonomy.md) | [Megatron SP](../assets/surveys/parallel-partitioning-taxonomy/megatron-sequence-parallel.png) | sequence-local compute、AG/RS 边界、TP partial 与阶段 activation ownership | `2400×1350` | 教学整理图 / 非论文证据 | passed：LuaLaTeX、原分辨率逐图检查、rank $r$/shape/buffer lifetime/AG-RS 语义 QA，2026-08-04 |
| [并行切分方法体系](../surveys/parallel-partitioning-taxonomy.md) | [Ulysses](../assets/surveys/parallel-partitioning-taxonomy/ulysses-layout-transpose.png) | sequence/head ownership transpose、sender chunks、receiver concat、local attention 与两次 A2A | `2400×1350` | 教学整理图 / 非论文证据 | passed：LuaLaTeX、原分辨率逐图检查、$p/r$/shape/sender-receiver/no-sum/layout 语义 QA，2026-08-04 |
| [并行切分方法体系](../surveys/parallel-partitioning-taxonomy.md) | [Ring/CP](../assets/surveys/parallel-partitioning-taxonomy/ring-context-parallel.png) | fixed local Q、rotating KV、block attention、online-softmax state、causal imbalance | `2400×1350` | 教学整理图 / 非论文证据 | passed：LuaLaTeX、原分辨率逐图检查、双输入不穿框、P2P/ownership/online state/causal matrix 语义 QA，2026-08-04 |
| [并行切分方法体系](../surveys/parallel-partitioning-taxonomy.md) | [CFGP](../assets/surveys/parallel-partitioning-taxonomy/cfg-branch-parallel.png) | branch assignment、并行 model forward、复制状态、output exchange、guidance combine 与 next step | `2400×1350` | 教学整理图 / 非论文证据 | passed：LuaLaTeX、原分辨率逐图检查、无越界/穿线、branch/state/exchange/combine 语义 QA，2026-08-04 |
