...
| [并行切分方法体系](../surveys/parallel-partitioning-taxonomy.md) | [PP](../assets/surveys/parallel-partitioning-taxonomy/pipeline-parallel-schedule.png) | stage 参数 ownership、单个 micro-batch 的 activation/gradient P2P、fill-drain 时间线与 bubble | `2400×1350` | 教学整理图 / 非论文证据 | passed：LuaLaTeX、原分辨率逐图检查、sequential schedule、P2P/ownership/bubble/节点类型语义 QA，2026-08-04 |
