...
> - 证据资产：[`../assets/papers/echo/`](../assets/papers/echo/)
> - 相关文档：[Figure inventory](../evidence/figure-inventory.md#echo)
...
![Figure 3: ECHO framework](../assets/papers/echo/fig3-framework.png)
...
![Figure 5: high-load results](../assets/papers/echo/fig5-high-load-results.png)
