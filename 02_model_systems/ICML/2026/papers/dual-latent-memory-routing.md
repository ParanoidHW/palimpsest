...
- 当前修订 ID：`rev-dual-latent-memory-routing-obsidian-properties-20260730`
- 当前文档版本：`1.5.2`
- 当前修订时间：`2026-07-30T23:45:00+08:00`
- 替代版本：`rev-dual-latent-memory-routing-affiliation-backfill-20260730` / `1.5.1`
...
| `rev-dual-latent-memory-routing-obsidian-properties-20260730` | `1.5.2` | `2026-07-30T23:45:00+08:00` | `metadata-update` | `rev-dual-latent-memory-routing-affiliation-backfill-20260730` / `1.5.1` | 无 | 无 |
