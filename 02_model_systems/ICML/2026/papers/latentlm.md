...
- 当前修订 ID：`rev-latentlm-obsidian-properties-20260730`
- 当前文档版本：`1.1.2`
- 当前修订时间：`2026-07-30T23:45:00+08:00`
- 替代版本：`rev-latentlm-affiliation-backfill-20260730` / `1.1.1`
...
| `rev-latentlm-affiliation-backfill-20260730` | `1.1.1` | `2026-07-30T23:30:00+08:00` | `/root` | `metadata-update` | `rev-latentlm-problem-solution-20260725` / `1.1.0` | 无 | 补充作者—机构元数据与角色证据边界 | 统一回填 affiliation 交付字段 | `作者与机构` | 论文 PDF 标题页、机构编号与角色脚注 | none：不改变方法、实验与归因结论 |
| `rev-latentlm-obsidian-properties-20260730` | `1.1.2` | `2026-07-30T23:45:00+08:00` | `/root` | `metadata-update` | `rev-latentlm-affiliation-backfill-20260730` / `1.1.1` | 无 | 增加 Obsidian YAML Properties 与层级标签 | ICML 2026 小范围标签呈现实验 | 文件头 YAML frontmatter | Obsidian 原生 tags/Properties 语法；仓库覆盖矩阵 | none：不改变论文分析与证据结论 |
...
- 第一作者（首位列名）：Yutao Sun → Microsoft Research；Tsinghua University。
- 共同第一作者（仅含论文明确标注者）：论文未显式标注。
- 通讯作者/通讯联系人（仅含论文明确标注者）：
  - Furu Wei → Microsoft Research
- 其他作者涉及的机构（去重列举，不作逐作者映射）：Microsoft Research；Tsinghua University。
- 对应依据：论文 PDF 标题页、作者机构编号与角色脚注（核验日期：2026-07-30）。
- 边界说明：论文的 * 表示 core contributors，不作为共同一作标记。
