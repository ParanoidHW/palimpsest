...
> - 相关文档：[D2SD](d2sd.md)，[P-EAGLE](p-eagle.md)
...
| 图表 | 本文档用途 | 文件 |
|---|---|---|
| Figure 1 | H100 上 DFlash/DDTree/JetSpec 端到端 speedup 对比 | `../assets/papers/jetspec/jetspec_fig1_speedup_caption.png` |
| Figure 2 | speculative decoding 随 draft length、acceptance、draft cost 的理论 scaling | `../assets/papers/jetspec/jetspec_fig2_scaling_caption.png` |
| Figure 3 | JetSpec causal-parallel draft head 和 tree verification 总览 | `../assets/papers/jetspec/jetspec_fig3_architecture_caption.png` |
| Table 1 | low-budget 16/32 token 结果 | `../assets/papers/jetspec/jetspec_table1_low_budget_caption.png` |
| Table 2 | high-budget 64/128/256 tree 结果 | `../assets/papers/jetspec/jetspec_table2_high_budget_caption.png` |
| Table 3 | learning-rate 消融 | `../assets/papers/jetspec/jetspec_table3_lr_ablation_caption.png` |
| Table 4-6 | loss、MoE 泛化、训练数据消融 | `../assets/papers/jetspec/jetspec_tables4_6_training_ablation_caption.png` |
| Table 7 | causal head vs diffusion head 对 $\gamma$ 的鲁棒性 | `../assets/papers/jetspec/jetspec_table7_head_gamma_caption.png` |
| Figure 4 | tree-quality failure mode 案例 | `../assets/papers/jetspec/jetspec_fig4_tree_quality_caption.png` |
| Table 8-9 | top-5 branch 与 50 prompt gap 分布 | `../assets/papers/jetspec/jetspec_tables8_9_tree_gap_caption.png` |
| Algorithm 1 | Parallel Tree Drafting 伪代码 | `../assets/papers/jetspec/jetspec_algorithm1_tree_drafting_caption.png` |
| Table 10 | tree construction scoring 消融 | `../assets/papers/jetspec/jetspec_table10_tree_algo_caption.png` |
| Table 11 | vLLM serving batch/budget sweep | `../assets/papers/jetspec/jetspec_table11_vllm_caption.png` |
| Table 12 | per-draft-token cost ratio $c$ | `../assets/papers/jetspec/jetspec_table12_draft_cost_caption.png` |
...
![JetSpec architecture|1051](../assets/papers/jetspec/jetspec_fig3_architecture_caption.png)
...
![Speculative decoding scaling|846](../assets/papers/jetspec/jetspec_fig2_scaling_caption.png)
...
![Headline speedup|905](../assets/papers/jetspec/jetspec_fig1_speedup_caption.png)
...
![Tree quality failure mode|969](../assets/papers/jetspec/jetspec_fig4_tree_quality_caption.png)
...
![Parallel Tree Drafting algorithm|673](../assets/papers/jetspec/jetspec_algorithm1_tree_drafting_caption.png)
...
![Low budget table|664](../assets/papers/jetspec/jetspec_table1_low_budget_caption.png)
...
![High budget table|636](../assets/papers/jetspec/jetspec_table2_high_budget_caption.png)
...
![Training ablations|737](../assets/papers/jetspec/jetspec_tables4_6_training_ablation_caption.png)
...
![Head gamma ablation|1024](../assets/papers/jetspec/jetspec_table7_head_gamma_caption.png)
...
![Tree algorithm ablation|884](../assets/papers/jetspec/jetspec_table10_tree_algo_caption.png)
...
![vLLM table](../assets/papers/jetspec/jetspec_table11_vllm_caption.png)
...
![Draft cost table|1013](../assets/papers/jetspec/jetspec_table12_draft_cost_caption.png)
