...
> 调研日期：2026-07-02  
> 中间产物：`../../_artifacts/output/speculative-decoding-deep-research/`  
> 说明：本文参考本目录已有精读材料与 `【Trends】Speculative Decoding.md` 的问题线索，但按新的论文检索、arXiv 元数据和 deep-research 六阶段结果重新组织，不直接沿用原文分析。

## 资料获取与可追溯性

本次调研过程中实际获取/使用了三类材料：

- **论文元数据与全文线索**：通过 arXiv API 检索并整理了 39 篇 paper 到 `../../_artifacts/output/speculative-decoding-deep-research/paper_db.jsonl`；Semantic Scholar 公共 API 当时返回 429，因此没有编造 citation count。
...
![投机推理方法时间演进趋势](../../_artifacts/output/speculative-decoding-deep-research/speculative_reasoning_timeline.png)
...
![P-EAGLE parallel drafter architecture|692](assets/architecture_single_column_v24.png)
...
![DFlash inference design|987](assets/dflash_inference_design.png)
...
![D2SD pipeline contrast|881](assets/d2sd_pipeline_contrast.png)
...
![JetSpec design overview|975](assets/jetspec_fig3_architecture_caption.png)
...
- 论文库：`../../_artifacts/output/speculative-decoding-deep-research/paper_db.jsonl`
- Frontier：`../../_artifacts/output/speculative-decoding-deep-research/phase1_frontier/frontier.md`
- Survey：`../../_artifacts/output/speculative-decoding-deep-research/phase2_survey/survey.md`
- Deep Dive：`../../_artifacts/output/speculative-decoding-deep-research/phase3_deep_dive/deep_dive.md`
- Code ecosystem：`../../_artifacts/output/speculative-decoding-deep-research/phase4_code/code_repos.md`
- Synthesis / gaps：`../../_artifacts/output/speculative-decoding-deep-research/phase5_synthesis/`
