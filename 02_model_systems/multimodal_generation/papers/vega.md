...
tags:
  ...
  - status/deep-review
  - topic/unified-video-models
  - method/hybrid-ar-diffusion
document_type: paper
...
- 版本：`1.0.2`
- 当前修订 ID：`rev-vega-obsidian-properties-20260731`
- 当前修订时间：`2026-07-31T10:00:00+08:00`
- 类型：metadata-update

| 修订 ID | 文档版本 | 时间 | 修订者 | 类型 | 替代修订 | 变更摘要 | 原因 | 影响位置 | 依据 | 对结论影响 |
|---|---|---|---|---|---|---|---|---|---|---|
| `rev-vega-affiliation-backfill-20260730` | `1.0.1` | `2026-07-30T23:30:00+08:00` | `/root` | `metadata-update` | `rev-vega-1.0.0` / `1.0.0` | 补充作者—机构元数据与角色证据边界 | 统一回填 affiliation 交付字段 | `作者与机构` | 论文 PDF 标题页、机构编号与角色脚注 | none：不改变方法、实验与归因结论 |
| `rev-vega-obsidian-properties-20260731` | `1.0.2` | `2026-07-31T10:00:00+08:00` | `/root` | `metadata-update` | `rev-vega-affiliation-backfill-20260730` / `1.0.1` | 增加 Obsidian YAML Properties 与层级标签 | 全量 canonical Paper 标签补齐 | 文件头 YAML frontmatter | 已验证的 ICML 2026 标签 schema；仓库覆盖矩阵 | none：不改变论文分析与证据结论 |

## 1. 核心结论

### 作者与机构

- 第一作者（首位列名）：Yuqi Wang → 论文标题页未披露。
- 共同第一作者（仅含论文明确标注者）：
  - Runyi Li → 论文标题页未披露
- 通讯作者/通讯联系人（仅含论文明确标注者）：论文未显式标注。
- 其他作者涉及的机构：论文未披露，无法核验。
- 对应依据：论文 PDF 标题页、作者机构编号与角色脚注（核验日期：2026-07-30）。
- 边界说明：PDF 标题页列出六位个人作者并标注前两位同等贡献，但全文未披露作者机构；因此不根据外部身份线索推断。
