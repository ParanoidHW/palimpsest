...
13. [MAGI-2 Preview](papers/magi-2-preview.md)：114B/6B Multi-Head LatentMoE、Head Parallel、MagiMoE 与 MagiMuon 训练系统路线。
...
本领域 `22/22` 篇 canonical Paper 已加入统一的 Obsidian YAML Properties：
...
- `assets/papers/magi-2-preview/`：MAGI-2 Preview Multi-Head LatentMoE 与训练 Infra 知识库整理图；不是原报告图表。
