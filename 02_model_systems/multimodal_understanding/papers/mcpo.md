...
> - 上位索引：[Paper Index](../evidence/paper-index.md)
> - 图表证据：[Figure Inventory](../evidence/figure-inventory.md)
> - 正式资产：[`assets/papers/mcpo/`](../assets/papers/mcpo/)
...
- 原始证据：[arXiv:2609.04947v1](https://arxiv.org/abs/2609.04947v1) 的 PDF 与 v1 LaTeX 源码；证据版本固定为 v1。
- 图表：Figures 1--4 均为 180 DPI PDF 页面裁图，完整 caption 保留在图片内；bbox、用途与逐图 QA 见 [Figure Inventory](../evidence/figure-inventory.md#mcpo-arxiv260904947v1)。
...
- 核验来源：arXiv v1 PDF title page；v1 LaTeX `sigconf.tex` author block。
...
![Figure 3：CLEVR 单例中的原链与剪枝链](../assets/papers/mcpo/fig3-clevr-case-caption.png)
...
![Figure 2：MCPO 离线剪枝与在线训练总览](../assets/papers/mcpo/fig2-mcpo-pipeline-caption.png)
...
![Figure 1：准确率、token 与难度分组总览](../assets/papers/mcpo/fig1-empirical-overview-caption.png)
...
![Figure 4：端到端时延与加速比](../assets/papers/mcpo/fig4-latency-caption.png)
...
- 审计证据：[Figure Inventory](../evidence/figure-inventory.md#mcpo-arxiv260904947v1)、严格 review validator 与 publisher validator 的机器结果，以及逐图原分辨率人工检查记录。
